...
int main()
{
    ...
    t.insert("alpha");
    t.insert("alpi");
    cout<<::boolalpha<<t.search("alpha")<<endl;
    cout<<::boolalpha<<t.search("beta")<<endl;
    cout<<::boolalpha<<t.search("alpi")<<endl;
    cout<<::boolalpha<<t.startsWith("alp")<<endl;
    cout<<::boolalpha<<t.startsWith("alpi")<<endl;
    cout<<::boolalpha<<t.startsWith("alb")<<endl;
